...
- 源码统计脚本当前报告：101 个手写 `.mbt` 文件，8,003 行总源码，6,823 行生产代码，1,180 行测试代码。
- 基准真实运行：`moon bench benchmarks`，`ethernet_ipv4_udp_parse` 为 472.67 ns ± 28.90 ns，10 × 100000 runs（Windows，MoonBit 0.1.20260814）。
